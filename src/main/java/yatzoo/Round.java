...
public class Round {
    ...
    public Round() {
        this.list = Arrays.asList(new String("Roll as many Lions as possible!"),
                new String("Roll as many Snakes as possible!"), new String("Roll as many Pigs as possible!"),
                new String("Roll as many Elephants as possible!"), new String("Roll as many Whales as possible!"),
